var ForceDirected = (function () {
    ...
    ForceDirected.prototype.drawGraphs = function () {
        var self = this;
        d3.json("miserable1.json").then(function (graph) {
            //  f = flatten(graph);
            g = graph;
...
////</editor-fold>
        ...
        function deleteNode(g) {
            ...
            linkdata.exit().transition().duration(1500)
                ...
                .remove();
            // self.simulation.nodes(g.nodes);
            // self.simulation.force("link").links(g.links);
        ...
        button_2.on("click", function () {
                self.circles
                    .transition().duration(750).attr("r", 5);
                d3.json("miserable1.json").then(function (graph2) {
